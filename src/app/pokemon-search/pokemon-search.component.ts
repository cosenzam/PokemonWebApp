    ...
    if (this.isLoading == false){
      if (this.textControl.value != "" && this.lastSearch != this.textControl.value){
        ...
        obsForkJoin1.subscribe((response : any[]) => {
          ...
          // wait for abilities response, then make poke-info div visible to avoid pop-in
